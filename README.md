...
If you only want to try out the App, you can use the video (back_5) and the sensor data (5.json) that we already recorded from a Swedish male professional athlete in order to develop our project. The Matlab code, back_5 and 5.json files must be in the same folder when you run the code of the App. 
